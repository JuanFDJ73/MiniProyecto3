...
public final class VentanaInicio extends JFrame {
    ...
    private void iniciarComponentes(){
        ...
        jlTitulo = new JLabel("A",SwingConstants.CENTER );
        ...
        btnJugar = new JButton("Añadir");
        btnJugar.setFont(new Font("Agency FB", Font.BOLD, 20));
        btnJugar.setBounds(150,310, 110,35);
        
        //Boton para cambiar de ventana
        btnJugar = new JButton("Ajustes");
        btnJugar.setFont(new Font("Agency FB", Font.BOLD, 20));
        btnJugar.setBounds(300,310, 110,35);
        
        //Botón para instrucciones
        btnInstrucciones = new JButton("Modificar");
        btnInstrucciones.setFont(new Font("Agency FB", Font.BOLD, 20)); 
        btnInstrucciones.setBounds(150,260, 110,35);
        ...
        if(!nombre.trim().isEmpty() || nombre.trim().length() > 0){
            AddWindow ventana1 = new AddWindow(); 
            dispose();               
